...
| [chore: Move inactive members to emeritus (#3587)](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3587) | opentelemetrybot |  | ✅ | ✅ | 2h |
| [fix(instrumentation-knex): use connectionSettings to support function-based connection configs (#3584)](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3584) | bhuvan-somisetty |  | ✅ | ✅ | 58m |
...
| [feat(several): only emit stable http, network and database attributes (#3585)](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3585) | maryliag | blumamir<br>jj22ee<br>martinkuba<br>maryliag<br>naseemkullah<br>neilime<br>onurtemizkan<br>pkanal<br>raphael-theriault-swi<br>seemk | ✅ | ✅ | 7h |
...
PR #3584
llm: pr-conversation -> reviewer (The author has already applied the suggested fix and is explicitly asking approvers/reviewers to review or sponsor the PR, so the next action is on reviewers/maintainers.)

PR #3583
llm: PRRT_kwDOD0IL486NNEfo -> author (The latest comment is from the author and says they will update the test assertion/mapping, so the author still has the next action.)
