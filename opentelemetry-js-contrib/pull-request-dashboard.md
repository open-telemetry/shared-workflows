...
| [chore: Move inactive members to emeritus (#3587)](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3587) | opentelemetrybot |  | ✅ | ✅ | 43m |
| [feat(instrumentation-oracledb): add support for oracledb v7 (#3583)](https://github.com/open-telemetry/opentelemetry-js-contrib/pull/3583) | abhilash-sivan | sharadraju&nbsp;💬<br>sudarshan12s&nbsp;💬 | ❌ | ✅ | 24m |
...
PR #3583
llm: PRRT_kwDOD0IL486NNEfo -> reviewer (The author acknowledged the requested change and said they will assert the current span attributes, so the thread is back with the reviewer to confirm or continue review.)
