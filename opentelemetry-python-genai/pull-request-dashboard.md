...
| [Update github actions (#182)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/182) | app/renovate | eternalcuriouslearner&nbsp;✅ | ✅ | ✅ | 2h |
| [Update github actions (major) (#183)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/183) | app/renovate | eternalcuriouslearner&nbsp;✅ | ✅ | ✅ | 2h |
| [Instrument OpenAI Responses.retrieve and AsyncResponses.retrieve (#184)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/184) | JacksonWeber | eternalcuriouslearner&nbsp;✅ | ✅ | ✅ | 29m |
...
| [\[`opentelemetry-instrumentation-google-genai`\] Instrument the embeddings API (#176)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/176) | DylanRussell | eternalcuriouslearner&nbsp;💬⁠✅<br>lmolkova&nbsp;✅ | ✅ | ✅ | 10m |
...
```text
PR #176
llm: PRRT_kwDOSbspP86M8wtt -> author (The reviewer asked a non-blocking follow-up question about creating an issue, so the author needs to जवाब/respond or decide whether to track it elsewhere.)
