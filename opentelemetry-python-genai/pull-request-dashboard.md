...
|---|---|---|:---:|:---:|:---:|
| [add missing permissions for release workflows (#222)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/222) | lmolkova | trask&nbsp;✅ | ❌ | ✅ | <1m |
...
| [Update all patch versions (#223)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/223) | app/renovate |  | ⏳ | ✅ | 1m |
...
| [Minor code scanning fixes (#221)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/221) | lmolkova |  | ❌ | ✅ | 19m |

## Waiting on external

| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [Add retrieval support in langchain (#124)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/124) | wrisa | eternalcuriouslearner<br>lmolkova&nbsp;💬 | ✅ | ✅ | 9h |
