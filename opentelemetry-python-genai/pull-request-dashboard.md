...
| [feat(langchain): add ChatAnthropic support to langchain instrumentation (#188)](https://github.com/open-telemetry/opentelemetry-python-genai/pull/188) | bhumikadangayach |  | ❌ | ✅ | 1h |
...
```text
PR #184
llm: PRRT_kwDOSbspP86NTaT2 -> author (A reviewer asked for clarification and said conventions need to be added first, so the author needs to respond and likely update the PR.)
