...
| [Use failExceptionally in PeriodicMetricReader when exporter is busy (#8525)](https://github.com/open-telemetry/opentelemetry-java/pull/8525) | vivekp14 | jack-berg&nbsp;✅ | ✅ | ✅ | 1h |
...
| [FIx for BSP benchmark aux counters (exportedSpans/droppedSpans) always reporting zero (#8539)](https://github.com/open-telemetry/opentelemetry-java/pull/8539) | EvgeniiR |  | ⏳ | ✅ | 45m |
| [Drop deprecated PrometheusMetricReader constructors (#8541)](https://github.com/open-telemetry/opentelemetry-java/pull/8541) | jack-berg |  | ⏳ | ✅ | 3m |
| [Remove deprecated InstrumentationConfigUtil.peerServiceMapping (#8542)](https://github.com/open-telemetry/opentelemetry-java/pull/8542) | jack-berg |  | ✅ | ✅ | 1m |
...
| [Suppress more test logs (#8536)](https://github.com/open-telemetry/opentelemetry-java/pull/8536) | jack-berg | psx95&nbsp;💬 | ✅ | ❌ | 33m |
