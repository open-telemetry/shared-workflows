...
| [Use failExceptionally in PeriodicMetricReader when exporter is busy (#8525)](https://github.com/open-telemetry/opentelemetry-java/pull/8525) | vivekp14 | jack-berg&nbsp;✅ | ✅ | ✅ | 35m |
...
| [Suppress more test logs (#8536)](https://github.com/open-telemetry/opentelemetry-java/pull/8536) | jack-berg |  | ✅ | ❌ | 50m |
...
| [Remove PR dashboard workflow (#8537)](https://github.com/open-telemetry/opentelemetry-java/pull/8537) | trask | jack-berg&nbsp;✅<br>jaydeluca&nbsp;✅ | ✅ | ✅ | 5m |
...
```text
PR #8537
llm: pr-conversation -> author (The reviewer is waiting to merge until the replacement dashboard appears, so the PR author needs to make that change or respond with progress.)
