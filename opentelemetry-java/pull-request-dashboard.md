...
| [Drop deprecated PrometheusMetricReader constructors (#8541)](https://github.com/open-telemetry/opentelemetry-java/pull/8541) | jack-berg | zeitlinger&nbsp;✅ | ✅ | ✅ | 18h |
...
| [Declarative config ref descriptions (#8540)](https://github.com/open-telemetry/opentelemetry-java/pull/8540) | jack-berg |  | ✅ | ✅ | 20h |
| [FIx for BSP benchmark aux counters (exportedSpans/droppedSpans) always reporting zero (#8539)](https://github.com/open-telemetry/opentelemetry-java/pull/8539) | EvgeniiR |  | ✅ | ✅ | 14h |
...
| [Jackson 3 support on Exporters (#8544)](https://github.com/open-telemetry/opentelemetry-java/pull/8544) | brunobat | 5h |
...
```text
PR #8536
llm: PRRT_kwDOCkv3g86MWBff -> author (The latest comment is a reviewer question asking whether the tests should pass without `ignoringFieldsOfTypes`, so the author needs to जवाब/clarify or update the PR.)
