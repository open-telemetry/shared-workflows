...
| [Replace jackson OTLP json serialization with handrolled version (#8545)](https://github.com/open-telemetry/opentelemetry-java/pull/8545) | jack-berg | EvgeniiR&nbsp;💬 | ✅ | ✅ | 29m |
...
| [Remove Jackson dependency from exporters (#8546)](https://github.com/open-telemetry/opentelemetry-java/pull/8546) | brunobat | 20h |
...
PR #8545
llm: PRRT_kwDOCkv3g86Mt8Xs -> author (A reviewer left a suggestion ('could be replaced with bool[16]'), so the PR author needs to respond or make the change.)
