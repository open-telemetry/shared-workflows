...
class GithubCliTest(unittest.TestCase):
    def test_generic_action_required_keeps_unknown_ownership(self) -> None:
        self.assertEqual(
            "action_required",
    ...
    def test_actions_workflow_approval_has_a_maintainer_owned_bucket(
        self,
    ) -> None:
        ...
        self.assertEqual("maintainer_action_required", check["bucket"])

    def test_actions_action_required_without_a_workflow_run_is_generic(
        self,
    ) -> None:
        check = normalize_check({
            "__typename": "CheckRun",
        ...
        self.assertEqual("action_required", check["bucket"])
