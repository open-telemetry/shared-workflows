...
class AuthorFollowUpPolicyTest(unittest.TestCase):
    ...
    def test_general_nudge_remains_due_one_week_from_route_start_after_fast_nudge(self) -> None:
        action, updated = plan_follow_up(
    ...
    def test_handoff_due_within_one_day_of_general_nudge_is_suppressed(self) -> None:
        action, updated = plan_follow_up(
            result(
        ...
        self.assertEqual(updated["handoff_suppressed_at"], "2026-07-15T00:00:00+00:00")
        self.assertEqual(updated["handoff_nudged_at"], "")

    def test_author_activity_after_suppression_waits_for_general_nudge(self) -> None:
        action, updated = plan_follow_up(
            result(
                author_activity="2026-07-16T12:00:00Z",
                waiting_since="2026-07-10T00:00:00Z",
            ...
            entry(
                waiting_on_author_since="2026-07-10T00:00:00Z",
                handoff_suppressed_at="2026-07-15T00:00:00Z",
            ),
