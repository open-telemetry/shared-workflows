...
| [gen-ai: model agent-to-agent handoff as execute_tool span (#98)](https://github.com/open-telemetry/semantic-conventions-genai/pull/98) | Krishnachaitanyakc | lmolkova<br>MikeGoldsmith&nbsp;✅<br>trask | ✅ | ❌ | 33m |
| [PR dashboard now lives in shared-workflows repo (#346)](https://github.com/open-telemetry/semantic-conventions-genai/pull/346) | trask |  | ✅ | ✅ | 12m |
...
PR #336
llm: PRRT_kwDOSUeMrM6MELJI -> reviewer (The author replied with an update and asked for another look (“PTAL”), so the ball is back with the reviewer to review the added scenario and metrics harness changes.)
