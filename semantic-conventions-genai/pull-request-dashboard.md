...
|---|---|---|:---:|:---:|:---:|
| [Update dependency google-genai to v2 (#112)](https://github.com/open-telemetry/semantic-conventions-genai/pull/112) | app/renovate | lmolkova&nbsp;✅ | ❌ | ✅ | 48d |
| [Add json-schema annotation for complex attributes, render boilerplate note in templates (#330)](https://github.com/open-telemetry/semantic-conventions-genai/pull/330) | lmolkova | JWinermaSplunk&nbsp;✅<br>trask&nbsp;✅ | ✅ | ✅ | 13h |

## Waiting on reviewers

| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [gen-ai: make input-messages BlobPart content optional and add stripped_reason (#144)](https://github.com/open-telemetry/semantic-conventions-genai/pull/144) | Mandark-droid | lmolkova<br>trask | ✅ | ❌ | 14d |
| [Align attributes between invoke_agent.internal and execute_tool spans and metrics (#322)](https://github.com/open-telemetry/semantic-conventions-genai/pull/322) | lmolkova | aabmass&nbsp;✅<br>trask&nbsp;✅ | ✅ | ❌ | 5d |
| [Update dependency google-adk to v2 (#328)](https://github.com/open-telemetry/semantic-conventions-genai/pull/328) | app/renovate |  | ❌ | ✅ | 5d |
...
| [Add Agent Framework reference scenario (#325)](https://github.com/open-telemetry/semantic-conventions-genai/pull/325) | eavanvalkenburg | lmolkova | ✅ | ✅ | 2d |
...
| [semconv for a2a protocol (#195)](https://github.com/open-telemetry/semantic-conventions-genai/pull/195) | eternalcuriouslearner | aabmass<br>JWinermaSplunk<br>pwkowalski&nbsp;💬⁠✔️<br>trask | ✅ | ✅ | 48m |
...
| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [Add gen_ai.server.inter_token_latency metric (#164)](https://github.com/open-telemetry/semantic-conventions-genai/pull/164) | Jwrede | Cirilla-zmh<br>lmolkova&nbsp;💬<br>trask | ✅ | ❌ | 37d |
| [gen-ai: add evaluation operation name and gen_ai.evaluate.internal span (#185)](https://github.com/open-telemetry/semantic-conventions-genai/pull/185) | hippoley | Cirilla-zmh&nbsp;💬<br>singankit&nbsp;💬 | ❌ | ✅ | 35d |
| [gen-ai: add gen_ai.response.id to deepeval evaluation result event (#184)](https://github.com/open-telemetry/semantic-conventions-genai/pull/184) | hippoley | lmolkova&nbsp;✅<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ✅ | 28d |
| [gen-ai: add optional byte_size to multimodal content parts (#143)](https://github.com/open-telemetry/semantic-conventions-genai/pull/143) | Mandark-droid | Cirilla-zmh<br>trask&nbsp;💬 | ✅ | ❌ | 26d |
| [Add modality, cache, and phase breakdowns for token usage (#197)](https://github.com/open-telemetry/semantic-conventions-genai/pull/197) | trask | alexmojaki&nbsp;💬<br>lmolkova&nbsp;💬<br>Nik-Reddy&nbsp;💬 | ✅ | ❌ | 25d |
| [Add gen_ai.invoke_agent.server span (SERVER kind) (#252)](https://github.com/open-telemetry/semantic-conventions-genai/pull/252) | singankit | Cirilla-zmh&nbsp;💬<br>trask | ✅ | ❌ | 20d |
| [Add gen_ai.agent.invocation.id attribute for invoke_agent spans (#250)](https://github.com/open-telemetry/semantic-conventions-genai/pull/250) | singankit | lmolkova&nbsp;💬<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ❌ | 15d |
| [Clarify scope of `gen_ai.client.operation.duration` metric (#215)](https://github.com/open-telemetry/semantic-conventions-genai/pull/215) | trask | lmolkova | ✅ | ❌ | 15d |
| [Add workflow node convention (#188)](https://github.com/open-telemetry/semantic-conventions-genai/pull/188) | RKest | aabmass<br>lmolkova&nbsp;🔴<br>trask | ✅ | ❌ | 15d |
| [Add gen_ai.agent.input.content.size and gen_ai.agent.output.content.size metrics (#202)](https://github.com/open-telemetry/semantic-conventions-genai/pull/202) | pvlsirotkin | lmolkova&nbsp;💬<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ❌ | 14d |
| [chore: auto-regenerate outputs on SEMCONV_VERSION bumps via Renovate post-upgrade task (#290)](https://github.com/open-telemetry/semantic-conventions-genai/pull/290) | lmolkova | Copilot<br>lmolkova&nbsp;✔️<br>trask&nbsp;💬 | ✅ | ✅ | 11d |
| [gen-ai: add run guardrail span and security finding (#262)](https://github.com/open-telemetry/semantic-conventions-genai/pull/262) | nagkumar91 | aabmass<br>habibam&nbsp;✔️<br>sjain700&nbsp;✔️<br>trask | ✅ | ❌ | 10d |
...
| [Add GenAI client metrics to the anthropic reference scenario (#283)](https://github.com/open-telemetry/semantic-conventions-genai/pull/283) | AgentGymLeader | JWinermaSplunk&nbsp;💬<br>MikeGoldsmith&nbsp;🔴 | ✅ | ✅ | 3d |
...
| [Rename gen_ai.workflow.duration to gen_ai.invoke_workflow.duration (#341)](https://github.com/open-telemetry/semantic-conventions-genai/pull/341) | lmolkova |  | ✅ | ✅ | 1d |
| [Add experimental GenAI context selection event (#190)](https://github.com/open-telemetry/semantic-conventions-genai/pull/190) | caioribeiroclw-pixel | lmolkova&nbsp;🔴<br>trask | ❌ | ❌ | 1d |
...
| [feat(gen-ai): add agent authorization observability attributes (#180) (#291)](https://github.com/open-telemetry/semantic-conventions-genai/pull/291) | thebenignhacker | lmolkova&nbsp;🔴 | ✅ | ✅ | 14h |
...
| [Scope PR dashboard Slack notifications (#282)](https://github.com/open-telemetry/semantic-conventions-genai/pull/282) | trask | 14d |
...
```text
PR #342
llm: PRRT_kwDOSUeMrM6L0npA -> reviewer (The author’s latest comment is a conditional offer to change the code (“happy to remove if people think it’s a problem”), so the ball is with reviewers/maintainers to decide whether action is needed.)

PR #341
llm: PRRT_kwDOSUeMrM6LymEa -> author (The latest comment is a bot review note pointing out trailing whitespace that should be fixed in the PR.)
llm: PRRT_kwDOSUeMrM6LymEn -> author (The bot reviewer flagged incomplete rename and asked for documentation updates plus regeneration, so the PR author needs to make the requested changes.)

PR #336
llm: PRRT_kwDOSUeMrM6MELJI -> reviewer (The author replied with the requested update and asked for review (“PTAL”), so the ball is back with the reviewer/maintainer.)
llm: PRRT_kwDOSUeMrM6LwmDS -> reviewer (The author addressed the wording change and updated the doc to count only client-side tools; the ball is back with the reviewer to confirm or close the thread.)

PR #322
llm: PRRT_kwDOSUeMrM6Ktirm -> reviewer (The latest comment is from the PR author and reads like an explanatory follow-up, so the ball is back with the reviewer to respond or resolve the thread.)

PR #291
llm: PRRT_kwDOSUeMrM6MHRum -> author (A reviewer asked for clarification about where the example’s attributes would come from, so the PR author needs to जवाब/respond or update the example.)
llm: pr-conversation -> author (The last comment is a reviewer asking for the scenario to use a real authorization step and set span attributes from the returned decision object instead of literals, so the PR author needs to update the implementation.)
...
PR #270
llm: PRRT_kwDOSUeMrM6KX_pc -> author (The latest comment is from a reviewer and it提出es alternative naming while disputing the author's suggestion, so the author needs to respond or revise the proposal.)
llm: PRRT_kwDOSUeMrM6KYD9u -> author (The latest comment is from a reviewer asking a follow-up question about the definition, so the author needs to जवाब/adjust the proposal.)

PR #262
llm: pr-conversation -> author (The last substantive comment is from a reviewer and adds a concrete follow-up suggestion (named defaults per subtype / worked examples), so the ball is back with the PR author to respond or update the PR.)
...
PR #195
llm: PRRT_kwDOSUeMrM6KRsU9 -> reviewer (The author asked whether they can resolve the thread; the reviewer should confirm closure or object if needed.)
...
PR #98
llm: pr-conversation -> reviewer (The author is asking whether it can be added to the merge queue and whether anything else is needed, so the ball is with the reviewer/maintainer to respond or merge.)
