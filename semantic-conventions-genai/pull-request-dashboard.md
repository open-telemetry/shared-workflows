...
| [semconv for a2a protocol (#195)](https://github.com/open-telemetry/semantic-conventions-genai/pull/195) | eternalcuriouslearner | aabmass<br>JWinermaSplunk<br>pwkowalski&nbsp;💬⁠✔️<br>trask | ✅ | ✅ | 17m |
...
| [Align attributes between invoke_agent.internal and execute_tool spans and metrics (#322)](https://github.com/open-telemetry/semantic-conventions-genai/pull/322) | lmolkova | trask&nbsp;✅ | ✅ | ❌ | 2d |
...
| [feat(gen-ai): add agent authorization observability attributes (#180) (#291)](https://github.com/open-telemetry/semantic-conventions-genai/pull/291) | thebenignhacker | lmolkova&nbsp;🔴 | ✅ | ✅ | 13h |
...
PR #322
llm: PRRT_kwDOSUeMrM6Kth7r -> reviewer (The latest comment is from the author explaining the change; the ball is with the reviewer to review or acknowledge it.)
...
llm: pr-conversation -> author (A reviewer left a concrete suggestion for an added fixture and follow-up coverage, so the PR author needs to respond or make the change.)
...
PR #98
llm: pr-conversation -> reviewer (The author asked whether anything else needs addressing and requested merge-queue action, so the next response/decision is with the reviewer/maintainer.)
