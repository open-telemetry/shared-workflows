...
| [Update gcr.io/oss-fuzz-base/base-builder-rust Docker digest to 8d1f850 (#1579)](https://github.com/open-telemetry/weaver/pull/1579) | app/renovate |  | ⏳ | ✅ | 20h |
...
| [Expand dependency conflict resolution to allow different versions if major-version is compatible (#1573)](https://github.com/open-telemetry/weaver/pull/1573) | jsuereth | 10h |
