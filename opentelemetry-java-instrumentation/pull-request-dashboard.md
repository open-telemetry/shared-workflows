...
|---|---|---|:---:|:---:|:---:|
| [feat: Add ConfigPropertiesBackedConfigProvider options for extensions and distros (#15835)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/15835) | aviralgarg05 | robsunday&nbsp;✔️<br>trask<br>zeitlinger&nbsp;✅ | ❌ | ✅ | 50d |
| [Align DynamoDB batch telemetry with database batch semantics (#19034)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19034) | trask | laurit&nbsp;✅ | ✅ | ✅ | 15h |
| [feat: add reactive command support for lettuce-4.0 instrumentation (#19071)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19071) | YaoYingLong | trask&nbsp;✅ | ✅ | ✅ | 13h |
...
| [Add OSGi support for library instrumentation, API, and SDK extension artifacts (#18995)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/18995) | royteeuwen |  | ✅ | ❌ | 10d |
...
| [Implement configurable metric bridge metric suppression (#19048)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19048) | somiljain2006 |  | ✅ | ✅ | 5d |
| [Add Vert.x Redis batch span support (#19057)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19057) | trask | laurit&nbsp;✅ | ❌ | ✅ | 2d |
| [fix(lettuce): set span status for Redis command errors in \[5.1.0, 6.0.0) (#19075)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19075) | YaoYingLong |  | ✅ | ✅ | 4h |
...
| [Reduce gradle warnings (#19079)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19079) | laurit |  | ⏳ | ✅ | 48m |
...
| [Add Cassandra JMX metrics target system (#19080)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19080) | jkoronaAtCisco |  | ✅ | ✅ | 18m |
...
```text
PR #19080
llm: PRRT_kwDODJKVX86MTe4z -> author (The bot left a review request to remove the stray bullet and restore the blank line, so the PR author needs to make that documentation fix.)
llm: PRRT_kwDODJKVX86MTe5C -> author (The bot flagged a placeholder changelog link and requested the PR author update it to the actual PR number.)

PR #19057
llm: PRRT_kwDODJKVX86LaU1C -> reviewer (The author says they changed the behavior in response to the feedback, so the ball is back with the reviewer to confirm or close the thread.)
