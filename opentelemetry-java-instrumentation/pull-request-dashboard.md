...
| [Fix ambiguous IPv6 address in db.connection_string for MySQL/MariaDB (#19078)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19078) | bhuvan-somisetty | laurit&nbsp;✅ | ✅ | ✅ | 18h |
...
| [Fix gradle warning (#19086)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19086) | laurit |  | ✅ | ✅ | 3h |
...
llm: PRRT_kwDODJKVX86MdYqE -> author (A reviewer suggested a code change and no one has responded yet, so the PR author needs to act or reply.)
llm: PRRT_kwDODJKVX86MddJE -> author (The reviewer notes the comment should be updated because there are no more module groups, so the author needs to revise the code/comment.)
