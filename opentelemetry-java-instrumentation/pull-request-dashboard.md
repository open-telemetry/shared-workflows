...
| [fix(deps): update graalvm buildtools packages to v1.1.3 (#19102)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19102) | app/renovate |  | ⏳ | ✅ | 40m |
| [fix(deps): update gradle shadow packages to v9.4.3 (#19103)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19103) | app/renovate |  | ⏳ | ✅ | 39m |
