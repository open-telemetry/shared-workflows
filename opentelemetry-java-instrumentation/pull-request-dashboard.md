...
| [getModuleGroup removal using common class-loaders for instrumentation modules. (#18859)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/18859) | SylvainJuge | JonasKunz&nbsp;✅<br>laurit<br>SylvainJuge<br>trask | ✅ | ✅ | 3h |
...
| [Add JFR metrics for virtual thread pinning and submit failures (#19092)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19092) | tsawada |  | ✅ | ✅ | 22h |
...
| [\[jdbc\] Capture custom object types in prepared statement parameter instrumentation (#19093)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19093) | CodingFabian |  | ❌ | ✅ | 14m |
...
| [Add Cassandra JMX metrics target system (#19080)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19080) | jkoronaAtCisco | laurit&nbsp;💬<br>trask | ✅ | ✅ | 11m |
...
```text
PR #19093
llm: pr-conversation -> reviewer (The latest comment is from the author asking others to point out missing issues in the PR, so the next action is for a reviewer to respond.)
...
PR #19080
llm: PRRT_kwDODJKVX86M82fx -> author (Reviewer suggested wording/formatting changes and asked for a better phrasing, so the author needs to update or जवाब back.)
llm: PRRT_kwDODJKVX86M83yV -> reviewer (The latest comment is a reviewer asking for clarification on a prior decision, so the next step is for a reviewer/maintainer to answer.)
