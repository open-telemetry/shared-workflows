...
| [fix(druid): optimize dataSourceName to resolve metrics high cardinality (#19108)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19108) | YaoYingLong | laurit&nbsp;💬 | ✅ | ✅ | 22h |
| [Set jms destination to null when it can't be extracted (#19115)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19115) | laurit |  | ✅ | ✅ | 3h |
| [Emit messaging operation metrics (publish/receive duration) from Kafka instrumentation (#19107)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19107) | maryantocinn | laurit | ✅ | ✅ | 3h |
...
llm: PRRT_kwDODJKVX86NRLQT -> reviewer (The author answered the reviewer’s question and explained the scope, so the ball is back with the reviewer to acknowledge or continue the review.)
llm: PRRT_kwDODJKVX86NRNZB -> reviewer (The author replied with a concrete decision and rationale, so the ball is back with the reviewer to acknowledge or continue the review.)
