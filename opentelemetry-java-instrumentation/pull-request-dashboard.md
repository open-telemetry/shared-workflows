...
| [switch non-inlined instrumentation by default + update doc (#19076)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19076) | SylvainJuge | laurit<br>SylvainJuge | ✅ | ✅ | 17h |
...
| [Set jms destination to null when it can't be extracted (#19115)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19115) | laurit |  | ❌ | ✅ | 21m |
| [Emit messaging operation metrics (publish/receive duration) from Kafka instrumentation (#19107)](https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/19107) | maryantocinn | laurit | ✅ | ✅ | 2m |
...
```text
PR #19115
llm: PRRT_kwDODJKVX86N1PtE -> author (The bot identified a real bug and requested a null guard in the queue path; the PR author needs to implement the fix or respond.)
...
llm: PRRT_kwDODJKVX86NQlac -> reviewer (The latest comments are from the author proposing a design and asking for guidance, so the ball is back with the reviewer/maintainer to respond or steer the approach.)
